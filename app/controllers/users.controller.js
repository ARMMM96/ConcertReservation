...
class User {
    static register = async (req, res) => {
        try {
            ...
            helper.responseHandler(res, 201, true, userData, "User registered successfully")
        }
        catch (e) {
    ...
    static login = async (req, res) => {
        try {
            ...
            helper.responseHandler(res, 200, true, { user: userData, token }, "user logedIn successfully")
        }
        catch (e) {
            helper.responseHandler(res, 500, false, e, e.message)
        }
    ...
    static profile = (req, res) => {
        helper.responseHandler(res, 200, true, { user: req.user }, "user profile fetched")
    }
        ...
        try {
            ...
            if (!user) {
                ...
                if (!isMatch) {
                    ...
                    helper.responseHandler(res, 400, false, null, "Current password is incorrect")
                ...
                helper.responseHandler(res, 200, true, user, "Password changed successfully")
            }
